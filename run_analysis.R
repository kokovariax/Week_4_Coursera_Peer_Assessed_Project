# Code
# BY ukachukwu Christian Chinweike
#Getting and cleaning data-week 4

# Loading required packages (packages already installed)
library(plyr)
library(dplyr)

#####READING AND EXPLORING FILES

#download and unzip the data from the provided URL and make sure you place all the necessary files in the same working directory.
...
write.table(df2, "tidy_data.txt", row.name=FALSE)